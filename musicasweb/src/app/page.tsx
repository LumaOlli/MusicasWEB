...
export default function Home() {
  const { playing, configPlayPause, playMusic, nextTrack, prevTrack, progress, seek, currentMusic } = useContext(HomeContext);
  ...
  return (
    <main className="flex min-h-screen flex-row p-24">
        ...
        <ul className="w-full">
          {musics.map((music) => (
            <li
              ...
              onClick={() => playMusic(music.url)} // Ao clicar, a música é tocada
            >
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        {/* Exibe o título e a imagem da música atual */}
